          ...
          {students.map(student => (
            <div key={student.id} className="h-46 md:h-72 bg-white shadow-md rounded-lg p-4 m-2">
              ...
              <button 
                ...
                className="bg-[#2D5990] hover:bg-[#00A0E3] text-white font-bold px-2 md:py-2 px-4 rounded focus:outline-none focus:shadow-outline block w-full text-xs md:text-sm h-8 md:h-12 mt-2 md:mt-4">
