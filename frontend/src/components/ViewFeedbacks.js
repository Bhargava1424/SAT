...
function ViewFeedbacks() {
  ...
  return (
    <div>
        <Navbar/>
        <div className="bg-gray-400 rounded-3xl mx-6 px-32 py-6">
        <div className="relative flex items-center justify-between mb-4">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2">
                <h2 className="text-2xl font-bold">View Feedbacks</h2>
            </div>
        </div>

    <div className="space-y-4">
    <div className="grid grid-cols-6 gap-4 items-center bg-gray-100 p-3 rounded shadow">
          <div>Profile</div>
          <div className='flex items-center justify-center'>Student Name</div>
          <div className='flex items-center justify-center'>Parent Name</div>
          <div className='flex items-center justify-center'>Student Name</div>
          <div className='flex items-center justify-center'>View Feedback</div>
          <div className='flex items-center justify-center'>Edit Feedback</div>
    </div>
      {data.map(item => (
        <div key={item.id} className="grid grid-cols-6 gap-4 items-center bg-gray-100 p-3 rounded shadow">
          <img src={item.pictureUrl} alt="Profile" className="w-12 h-12 rounded-full flex items-center justify-center" />
          <div className='flex items-center justify-center'>{item.studentName}</div>
          <div className='flex items-center justify-center'>{item.parentName}</div>
